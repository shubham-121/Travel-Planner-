...
export default function Homepage() {
  return (
    <div className="bg-[url('https://images.travelandleisureasia.com/wp-content/uploads/sites/3/2024/09/21141044/world-tourism-day.jpeg')] bg-cover bg-center bg-no-repeat w-screen h-screen relative z-[1000]">
      <Outlet />
      {/* <Header /> */}
      <BodyContent />
      <Footer />
